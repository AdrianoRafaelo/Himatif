...
@section('content')
    @if(session('user')['role'] === 'bendahara')
        {{-- Bendahara hanya melihat grafik --}}
        <div class="container py-4">
            <h2 class="mb-4 fw-bold">Grafik Keuangan</h2>
    ...
    @else
        {{-- Dashboard lengkap untuk role lain --}}
        <!-- Notifikasi sukses -->
        @if(session('success'))
        ...
        <div class="row px-4 fade-in">
            ...
            <!-- Grafik Keuangan di posisi yang diinginkan (misal, di bawah cards) -->
            <div class="container py-4">
                <h2 class="mb-4 fw-bold">Grafik Keuangan</h2>
                <form method="GET" class="mb-3">
                    <label for="periode" class="me-2 fw-bold">Periode Grafik:</label>
